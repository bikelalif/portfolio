    ...
    <header className="bg-gradient-to-r from-slate-800 via-slate-700 to-slate-800 text-white">
      <div className="max-w-6xl mx-auto px-4 py-16">
        <div className="text-center">
          <div className="w-32 h-32 mx-auto mb-6 rounded-full bg-white/10 backdrop-blur-sm flex items-center justify-center overflow-hidden border-4 border-white/30 shadow-2xl">
            <img src="/photo_profil.jpg" alt="Bilal KEFIF" className="w-full h-full object-cover" />
          </div>
          <h1 className="mb-2">Bilal KEFIF</h1>
          <p className="text-xl text-white/90 mb-6">Étudiant Ingénieur en Génie Logiciel</p>
